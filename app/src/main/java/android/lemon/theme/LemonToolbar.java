...
public class LemonToolbar extends Toolbar {
    ...
    /**
     * {@link Toolbar mTitleTextAppearance }
     */
    ...
    public LemonToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewUtil.addOnGlobalLayoutListener(this, new Runnable() {
            @Override
            public void run() {
                if (!isLoad) {
                    isLoad = true;
    ...
    OnClickListener navOnClickListener ;
    ...
    public void titleInCenter(String title, String subTitle) {
        ...
        if (centerLinearLayout == null) {
            LayoutParams tlp = generateDefaultLayoutParams();
